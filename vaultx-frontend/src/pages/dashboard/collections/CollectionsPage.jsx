        ...
        <div className="flex items-center gap-4">
          <div className="relative">
            ...
            <input
              ...
              className="w-72 pl-10 pr-4 py-2 bg-white border border-gray-200 rounded-xl text-sm outline-none focus:border-primary transition-colors font-medium shadow-sm"
            />
          </div>
          <button
            onClick={() => setShowCreateModal(true)}
            className="flex items-center gap-2 px-5 py-2.5 bg-primary text-white font-bold rounded-xl hover:bg-primary-dark transition-colors shadow-md shadow-primary/30"
          >
              ...
              <div>
                ...
                <div className="p-5">
                  <div className="flex items-start justify-between mb-4">
                    <div className={`w-12 h-12 rounded-xl bg-gradient-to-br ${getColor(idx)} flex items-center justify-center shadow-md`}>
                  ...
                  <h3 className="font-bold text-gray-800 text-lg mb-1 truncate">{col.name}</h3>
                  {col.description && (
                    <p className="text-gray-500 text-sm line-clamp-2 mb-3">{col.description}</p>
                  )}
