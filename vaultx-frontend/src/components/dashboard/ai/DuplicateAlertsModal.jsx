...
import { X, FileWarning, Trash2, ShieldAlert, CheckCircle2, FileText, ArrowRight } from 'lucide-react';
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              <h2 className="text-xl font-bold flex items-center gap-2">
                ...
                <span className="px-2.5 py-0.5 text-xs bg-white/20 rounded-full font-normal">Vault Cleanup</span>
              </h2>
              <p className="text-amber-100 text-xs mt-0.5">
                Exact binary duplicates detected by SHA-256 checksum matching
              </p>
            </div>
          </div>
          <button 
        ...
        <div className="flex-1 overflow-y-auto p-6">
          {isLoading ? (
            <div className="py-16 text-center">
              ...
              <p className="text-sm text-gray-500">Scanning checksums for exact duplicates...</p>
            </div>
          ) : groups.length === 0 ? (
            <div className="py-16 text-center border-2 border-dashed border-emerald-200 bg-emerald-50/30 rounded-2xl">
              ...
              <p className="text-xs text-gray-500 max-w-xs mx-auto mt-1">
                No redundant duplicate files found in your document storage.
              </p>
            </div>
          ) : (
